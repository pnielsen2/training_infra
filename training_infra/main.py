...
sampler_dict = {
    'sequential': lambda weights: SequentialSampler(y),
...
# @profile
def train(using_wandb, dataset_name, config=None):
    if using_wandb:
        ...
        while True:
            ...
            for stat in ['Loss']:
                ...
                if stat_value < best_models[stat]['value']:
                    ...
                    torch.save(model, f'best_{dataset_name}_{architecture}_architecture.p')
